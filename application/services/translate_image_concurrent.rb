...
module TranslateThis
  ...
  class TranslateImageConcurrent
    ...
    def get_translations_from_db(input)
      translation_checker_con = TranslateThis::Entity::TranslationCheckerConcurrent
                            .new(input[:config],
                                 input[:routing],
                                 input[:img])
      translations = translation_checker_con.check_translations
